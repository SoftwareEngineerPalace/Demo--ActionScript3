package com.vox.test.utils
{
	 ...
	 * @author Xiaojianjun
	 * @version 1.0
	 * @policy 随着整体的大小变化，外框的尺寸不能变.
	 * @1 传入的是要显示的DisplayObject和 选定的中间Rectangle 注意要给这个Rectangle设置x和y值 然后立即绘制九宫
	 * @2 设定width 和  height 
	 * @3 最后merge生成要的东西.
	 */	
	public class Scale9GridSpr extends Sprite
	{
		...
		override public function set width(value:Number):void
		{
			...
			/*第三列的x值 会有变化*/
			_right_up_bmp.x = _left_up_bmp.width + _up_bmp.width;

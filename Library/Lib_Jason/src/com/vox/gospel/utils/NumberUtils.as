package　com.vox.gospel.utils
{
  ...
  /**
   * 暂时加的，并没有对里面的方法验证和整理. 肖建军@20140728
   */
  public class NumberUtils 
  {
	...
	{
      // Return the result
     	var first:Number = Math.round(nNumber / nRoundToInterval) ;
		var temp:int = Math.round( 1 / nRoundToInterval ) ;
		var second:Number = first / temp ;
		return second ;
    }

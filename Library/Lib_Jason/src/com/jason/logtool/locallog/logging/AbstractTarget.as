...
{
	import com.jason.logtool.locallog.logging.errors.InvalidFilterError;
    ...
    public function set filters(value:Array):void
    {
        if (value && value.length > 0)
        {
            ...
            for (var i:uint = 0; i<value.length; i++)
            {
                ...
                {
                    message = "filters has invalide characters";
                ...
                {
                    message = "the \"*\" must be in the tail of filter";
                    throw new InvalidFilterError(message);
                }
            } // for
        }
...
//        Log.addTarget(this);        
     ...
     *  @productversion Flex 3
     */
    public function initialized(document:Object):void
    {
        Log.addTarget(this);
    }

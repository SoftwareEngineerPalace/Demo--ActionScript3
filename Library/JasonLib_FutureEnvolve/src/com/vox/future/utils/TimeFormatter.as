...
package com.vox.future.utils
{
	 ...
	 * <li>s	: millisecond with one or two digits (3)</li>
	 * <li>ss	: millisecond with two digits (03)</li>
	 * 
	...
	public class TimeFormatter 
	{
		 ...
		 * @private
		 */
		protected static const __PATTERNS : Array = new Array( "w" , "ww" , "d" , "dd" , "h" , "hh" , "m" , "mm" , "S" , "SS" , "s" , "ss" );
		...
		private static function __convertPattern ( pattern : String , milliseconds : Number , roundPattern : String = null , overflowPatterns : Array = null ) : String
		{
			switch( true )
			{
				...
				case pattern == "ww"	: 
					return NumberUtils.digitFormat( getWeeks( milliseconds ) );
				case pattern == "d"		: 
					return String( getDays( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "dd"	: 
					return NumberUtils.digitFormat( getDays( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "h"		: 
					return String( getHours( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "hh"	: 
					return NumberUtils.digitFormat( getHours( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "m"		: 
					return String( getMinutes( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "mm"	: 
					return NumberUtils.digitFormat( getMinutes( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "S"		: 
					return String( getSeconds( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "SS"	: 
					return NumberUtils.digitFormat( getSeconds( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "s"		: 
					return String( getMilliseconds( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) );
				case pattern == "ss"	: 
					return NumberUtils.digitFormat( getMilliseconds( milliseconds , overflowPatterns.indexOf( pattern ) >= 0 , roundPattern == pattern ) , 3 );
				default					:

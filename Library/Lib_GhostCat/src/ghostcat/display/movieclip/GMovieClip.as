package ghostcat.display.movieclip
{
	...
	public class GMovieClip extends GMovieClipBase
	{
		 ...
		 *
		 */
		public function GMovieClip(mc:*=null, replace:Boolean=true, paused:Boolean=false, replaceSkin:*=null)
		{
			super(mc, replace, paused, replaceSkin);
		}

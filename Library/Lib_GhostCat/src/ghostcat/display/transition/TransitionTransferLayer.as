package ghostcat.display.transition
{
    ...
    public class TransitionTransferLayer extends TransitionLayerBase
    {
        ...
        public function TransitionTransferLayer(switchHandler:*,transfer:GBitmapEffect,fadeOut:int = 1000,wait:Boolean = false,easeOut:Function = null,onComplete:Function = null)
        {
            ...
            if (fadeOut)
                fadeOutOper = new TweenOper(this.transfer,fadeOut,{alpha: 1.0,ease: easeOut /*,onCompleteHandler: onComplete*/});
            if (wait)

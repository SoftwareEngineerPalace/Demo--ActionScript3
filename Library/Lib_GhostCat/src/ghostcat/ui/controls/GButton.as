package ghostcat.ui.controls
{
	...
	public class GButton extends GButtonBase
	{
		...
		/** 是否允许按钮音效——Raykid */
		public var enableBtnSound:Boolean = true;
		 ...
		 *
		 */
		public function GButton(skin:*=null, replace:Boolean=true, replaceSkin:*=null, separateTextField:Boolean=false, textPadding:Padding=null, autoRefreshLabelField:Boolean=true)
		{
			if (!skin)
				skin=GButton.defaultSkin;

			super(skin, replace, replaceSkin, separateTextField, textPadding, autoRefreshLabelField);
		}

package ghostcat.ui.controls
{
	...
	public class GNumbericStepper extends GNumberic
	{
		...
		public function GNumbericStepper(skin:*=null, replace:Boolean=true, enabledAdjustContextSize:Boolean=false, textPadding:Padding=null, fields:Object=null, replaceSkin:*=null)
		{
			if (!skin)
				skin=defaultSkin;
			...
			super(skin, replace, enabledAdjustContextSize, textPadding, replaceSkin);

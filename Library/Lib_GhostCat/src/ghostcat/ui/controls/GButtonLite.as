package ghostcat.ui.controls
{
    ...
    public class GButtonLite extends GBase
    {
        ...
        public static const LABELS:Array = [[LABEL_UP,LABEL_SELECTED_UP],[LABEL_OVER,LABEL_SELECTED_OVER],[LABEL_DOWN,LABEL_SELECTED_DOWN],[LABEL_DISABLED,LABEL_SELECTED_DISABLED]];
        ...
        public function GButtonLite(skin:* = null,replace:Boolean = true,replaceSkin:* = null)
        {
            this.buttonStates = {up: this.upState,over: this.overState,down: this.downState,disabled: this.disabledState,selectedUp: this.selectedUpState,selectedOver: this.selectedOverState,selectedDown: this.selectedDownState,selectedDisabled: this.selectedDisabledState};
        ...
        {
            defaultSkin = skin;
            setPartContent(skin,replace,replaceSkin);
        }
         ...
         *
         */
        public function setPartContent(skin:*,replace:Boolean = true,replaceSkin:* = null):void
        {

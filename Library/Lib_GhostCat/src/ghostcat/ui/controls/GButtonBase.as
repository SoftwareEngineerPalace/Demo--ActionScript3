package ghostcat.ui.controls
{
	...
	public class GButtonBase extends GButtonLite
	{
		...
		public static var defaultLabels:Array=[new FrameLabel("up", 1), new FrameLabel("over", 2), new FrameLabel("down", 3), new FrameLabel("disabled", 4), new FrameLabel("selectedUp", 5), new FrameLabel("selectedOver", 6), new FrameLabel("selectedDown", 7), new FrameLabel("selectedDisabled", 8)];
		public static var defaultLabels_3frame:Array=[new FrameLabel("up", 1), new FrameLabel("over", 2), new FrameLabel("down", 3), new FrameLabel("disabled", 1), new FrameLabel("selectedUp", 1), new FrameLabel("selectedOver", 2), new FrameLabel("selectedDown", 3), new FrameLabel("selectedDisabled", 1)];
		 ...
		 *
		 */
		public function GButtonBase(skin:*=null, replace:Boolean=true, replaceSkin:*=null, separateTextField:Boolean=false, textPadding:Padding=null, autoRefreshLabelField:Boolean=true)
		{
		...
		{
			return _label != null ? _label : (data && labelField && data.hasOwnProperty(labelField)) ? data[labelField] : (data is String || data is Number) ? data : null;
		}
		 ...
		 *
		 */
		public override function setPartContent(skin:*, replace:Boolean=true, replaceSkin:*=null):void
		{
			super.setPartContent(skin, replace, replaceSkin);

...
//		protected var buttonRef:Class;
		...
		public static const fields_data:Object={upArrowField: "upArrow", downArrowField: "downArrow", thumbField: "thumb", backgroundField: "background", upArrowClass: GButton, downArrowClass: GButton, thumbClass: GButton, backgroundClass: GButton}
		public var fields:Object

		public function GSilder(skin:*=null, replace:Boolean=true, fields:Object=null, replaceSkin:*=null)
		{
			this.fields=fields ? fields : fields_data;
		...
		protected function createButtons():void
		{
			...
			{
				this.upArrow=new fields.upArrowClass(content[upArrowField]);
			...
			{
				this.downArrow=new fields.downArrowClass(content[downArrowField]);
			...
			{
				this.thumb=new fields.thumbClass(content[thumbField]);
				thumb.addEventListener(MouseEvent.MOUSE_DOWN, thumbMouseDownHandler);
				if(thumb is GButton) GButton(thumb).enableBtnSound = false;
			}

			if (content.hasOwnProperty(backgroundField))
			{
				this.background=new fields.backgroundClass(content[backgroundField]);

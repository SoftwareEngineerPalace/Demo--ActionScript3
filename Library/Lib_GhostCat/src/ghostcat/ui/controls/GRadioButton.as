package ghostcat.ui.controls
{
	...
	public class GRadioButton extends GButton
	{
		...
		public function GRadioButton(skin:*=null, replace:Boolean=true, replaceSkin:*=null, separateTextField:Boolean=false, textPadding:Padding=null, autoRefreshLabelField:Boolean=true)
		{
			if (!skin)
				skin=defaultSkin;

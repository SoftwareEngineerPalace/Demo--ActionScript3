package ghostcat.ui.controls
{
	...
	public class GScrollBar extends GSilder
	{
		...
		public function GScrollBar(skin:*=null, replace:Boolean=true, fields:Object=null,replaceSkin:*=null)
		{
		...
		public function tweenToValue(v:Number, update:Boolean=false):void
		{
			...
			if (direction == UIConst.HORIZONTAL)
			{
				...
				if (duration > 0)
				{
					...
					TweenUtil.to(_scrollContent, duration, {scrollH: v, ease: easing, onUpdate: update ? tweenUpdateWithThumb : tweenUpdateHandler, onStart: tweenStartHandler, onComplete: tweenCompleteHandler});
			...
			else
			{
				...
				{
					TweenUtil.removeTween(_scrollContent, false);
					TweenUtil.to(_scrollContent, duration, {scrollV: v, ease: easing, onUpdate: update ? tweenUpdateWithThumb : tweenUpdateHandler, onStart: tweenStartHandler, onComplete: tweenCompleteHandler});

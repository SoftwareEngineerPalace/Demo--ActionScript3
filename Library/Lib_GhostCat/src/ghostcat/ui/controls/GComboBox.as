package ghostcat.ui.controls
{
	...
	public class GComboBox extends GButton
	{
		...
		public function GComboBox(skin:*=null, replace:Boolean=true, replaceSkin:*=null, separateTextField:Boolean=false, textPadding:Padding=null, fields:Object=null, autoRefreshLabelField:Boolean=true)
		{
			if (!skin)
				skin=defaultSkin;

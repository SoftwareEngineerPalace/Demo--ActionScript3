package ghostcat.util.text
{
	...
	public final class TextTweenUtil
	{
		 ...
		 * @param ease	缓动方法
		 */
		public static function tweenQuick(textField:TextField,duration:Number = 100,ease:Function = null,onComplete:Function=null):TweenUtil
		{
			...
			var tween:TweenUtil = TweenUtil.to(data, duration,{len: length,ease: ease, onUpdate: updateHandler,onComplete:completeHandler});
			tween.update();
			return tween;
			...
			function completeHandler():void
			{
				...
				if(onComplete !=null)
				{
					TweenUtil.callLater(onComplete,null,500);
				}
			}
		}
	}

package ghostcat.util.display
{
    ...
    public final class BitmapUtil
    {
         ...
         * @param smoothing 平滑
         */
        public static function drawToRectangle(source:IBitmapDrawable,target:BitmapData,targetRect:Rectangle,smoothing:Boolean = true):void
        {
            var m:Matrix = new Matrix();
        ...
        public static function scale(source:BitmapData,scaleX:Number = 1.0,scaleY:Number = 1.0,disposeSource:Boolean = true):BitmapData
        {
            ...
            result.draw(source,m,null,null,null,true);
            if (disposeSource)
                source.dispose()
            return result;
        }
